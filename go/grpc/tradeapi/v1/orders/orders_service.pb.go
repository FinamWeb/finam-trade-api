...
const file_grpc_tradeapi_v1_orders_orders_service_proto_rawDesc = "" +
	...
	"\x10DATA_TYPE_TRADES\x10\x02:\x02\x18\x01\"\x89\x01\n" +
	...
	"\x1bVALID_BEFORE_GOOD_TILL_DATE\x10\x032\x90\t\n" +
	...
	"\x03404\x12;\n" +
	"9Счёт или заявка не были найденыR\x01\x01\x82\xd3\xe4\x93\x02-\x12+/v1/accounts/{account_id}/orders/{order_id}\x12r\n" +
	"\x13SubscribeOrderTrade\x12*.grpc.tradeapi.v1.orders.OrderTradeRequest\x1a+.grpc.tradeapi.v1.orders.OrderTradeResponse(\x010\x01B\xf3\x04\x92A\xad\x04*\x01\x01Ri\n" +
	"\x03401\x12b\n" +
