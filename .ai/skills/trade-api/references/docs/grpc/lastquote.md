...
**Path:** /grpc.tradeapi.v1.marketdata.MarketDataService/LastQuote
...
| --- | --- | --- | --- |
| symbol | string | no | Символ инструмента |
| quote | Quote | no | Цена последней сделки |
...
grpcurl \
  ...
  api.finam.ru:443 grpc.tradeapi.v1.marketdata.MarketDataService/LastQuote
```