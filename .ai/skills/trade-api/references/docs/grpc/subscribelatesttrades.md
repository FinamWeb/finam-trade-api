...
**Path:** /grpc.tradeapi.v1.marketdata.MarketDataService/SubscribeLatestTrades
...
| --- | --- | --- | --- |
| symbol | string | no | Символ инструмента |
| trades | Trade[] | yes | Список сделок |
...
grpcurl \
  ...
  api.finam.ru:443 grpc.tradeapi.v1.marketdata.MarketDataService/SubscribeLatestTrades
```