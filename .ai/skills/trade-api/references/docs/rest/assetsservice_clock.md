...
const response = await fetch('https://api.finam.ru/v1/assets/clock', {
  method: 'GET',
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/assets/clock", nil)
...
$ch = curl_init('https://api.finam.ru/v1/assets/clock');
...
curl -X GET 'https://api.finam.ru/v1/assets/clock' \
