...
**Path:** /v1/report/{report_id}/info

## Path Parameters

| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| report_id | string | yes | Идентификатор отчёта |
...
const response = await fetch('https://api.finam.ru/v1/report/YOUR_REPORT_ID/info', {
  method: 'GET',
  headers: {
...
response = requests.get(
    "https://api.finam.ru/v1/report/YOUR_REPORT_ID/info",
    headers={
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/report/YOUR_REPORT_ID/info", nil)
...
$ch = curl_init('https://api.finam.ru/v1/report/YOUR_REPORT_ID/info');
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/report/YOUR_REPORT_ID/info")
        .bearer_auth(token)
        .send().await?;
...
curl -X GET 'https://api.finam.ru/v1/report/YOUR_REPORT_ID/info' \
