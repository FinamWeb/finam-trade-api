...
const response = await fetch(`https://api.finam.ru/v1/assets/YOUR_SYMBOL/params?${params}`, {
  method: 'GET',
  headers: {
...
response = requests.get(
    "https://api.finam.ru/v1/assets/YOUR_SYMBOL/params",
    headers={
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/assets/YOUR_SYMBOL/params?"+params.Encode(), nil)
...
$ch = curl_init('https://api.finam.ru/v1/assets/YOUR_SYMBOL/params?' . http_build_query(['account_id' => 'YOUR_ACCOUNT_ID']));
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/assets/YOUR_SYMBOL/params")
        .bearer_auth(token)
...
curl -X GET 'https://api.finam.ru/v1/assets/YOUR_SYMBOL/params?account_id=YOUR_ACCOUNT_ID' \
