...
const response = await fetch('https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID', {
  method: 'GET',
  headers: {
...
response = requests.get(
    "https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID",
    headers={
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID", nil)
...
$ch = curl_init('https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID');
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID")
        .bearer_auth(token)
        .send().await?;
...
curl -X GET 'https://api.finam.ru/v1/accounts/YOUR_ACCOUNT_ID' \
