...
const response = await fetch('https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook', {
  method: 'GET',
  headers: {
...
response = requests.get(
    "https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook",
    headers={
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook", nil)
...
$ch = curl_init('https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook');
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook")
        .bearer_auth(token)
        .send().await?;
...
curl -X GET 'https://api.finam.ru/v1/instruments/YOUR_SYMBOL/orderbook' \
