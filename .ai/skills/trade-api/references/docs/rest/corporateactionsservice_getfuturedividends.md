...
const response = await fetch(`https://api.finam.ru/v1/future-dividends?${params}`, {
  method: 'GET',
  headers: {
...
response = requests.get(
    "https://api.finam.ru/v1/future-dividends",
    headers={
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/future-dividends?"+params.Encode(), nil)
...
$ch = curl_init('https://api.finam.ru/v1/future-dividends?' . http_build_query(['symbol' => 'YOUR_SYMBOL', 'sort_direction' => 'YOUR_SORT_DIRECTION', 'limit' => 'YOUR_LIMIT', 'offset' => 'YOUR_OFFSET']));
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let response = client
        .get("https://api.finam.ru/v1/future-dividends")
        .bearer_auth(token)
...
curl -X GET 'https://api.finam.ru/v1/future-dividends?symbol=YOUR_SYMBOL&sort_direction=YOUR_SORT_DIRECTION&limit=YOUR_LIMIT&offset=YOUR_OFFSET' \
