...
const response = await fetch('https://api.finam.ru/v1/exchanges', {
  method: 'GET',
  headers: {
...
func main() {
    ...
    req, _ := http.NewRequest("GET", "https://api.finam.ru/v1/exchanges", nil)
...
$ch = curl_init('https://api.finam.ru/v1/exchanges');
...
curl -X GET 'https://api.finam.ru/v1/exchanges' \
